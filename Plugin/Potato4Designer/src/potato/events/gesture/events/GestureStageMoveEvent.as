package potato.events.gesture.events
{
	 ...
	 * 
	 */	
	public class GestureStageMoveEvent extends Gesture
	{
		public function GestureStageMoveEvent()
		{
			eventID = "gestureStageMove";
			eventName = GestureEvent.GESTURE_STAGE_MOVE;
		}
		...
		override public function initEvent(uiComponent:UIComponent, listener:Function):void{
			...
			_stage.addEventListener(TouchEvent.TOUCH_MOVE,listener);
			_stage.addEventListener(TouchEvent.MULTI_TOUCH_MOVE,listener);
		...
		private function sendEvent(touchEvent:TouchEvent):void{
			...
			var gestureEvent:GestureEvent = new GestureEvent(GestureEvent.GESTURE_STAGE_MOVE,false,touchEvent.stageX,touchEvent.stageY);
		...
		override public function clear():void{
			...
			_stage.removeEventListener(TouchEvent.TOUCH_MOVE,_stageFun);
			_stage.removeEventListener(TouchEvent.MULTI_TOUCH_MOVE,_stageFun);
